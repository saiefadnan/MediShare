...
const Cards = () => {
    return ( 
        <div style={{ 
            ...
            color: "#333"}}>
            <Card sx={{ padding: '20px', backgroundColor: ' #FFE2E5', height: '130px', width: '280px', margin: '50px auto'}}>
            ...
            <Card sx={{ padding: '20px', backgroundColor: ' #FFF4DE', height: '130px', width: '280px', margin: '50px auto'}}>
                <Typography variant="h6">
                    <img src={time} style={{padding: '0px 10px 0px 0px'}}></img>
                    Expired Meds</Typography>
                <Typography variant="h5" sx={{ fontWeight: 'bold', }}>Total 12,200</Typography>
            </Card>
            <Card sx={{ padding: '20px', backgroundColor: ' #DCFCE7', height: '130px', width: '280px', margin: '50px auto'}}>
                <Typography variant="h6">
            ...
            <Card sx={{ padding: '20px', backgroundColor: ' #F3E8FF', height: '130px', width: '280px', margin: '50px auto'}}>
                <Typography variant="h6">
