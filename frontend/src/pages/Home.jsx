...
import sayef from '../assets/sayef.png';
    ...
    <div className="Home">
      ...
      <section className='aboutus-section'>
        <div className='about-us'>
          ...
          <h3 style={{ color: '#393633', fontFamily: 'Quando', paddingBottom: '10px' }}>
          ...
          <p style={{ fontSize: '15px', color: '#464135', fontFamily: 'Roboto', paddingTop: '1%' }}>
            Get involved
          </p>
            ...
            <Row>
              <Col style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <div className="card69">
                  ...
                  <span>About Me</span>
                  <p className="info">Assalamu Alaikum. I am Mir Sayef Ali. A gaming and movie enthusiast who binge watches series left and right. Trying my best to be the best coder in the world. Not too focused on worldly things because “Indeed, we belong to Allah, and indeed, to Him we return.”</p>
                  <div className="share">
              ...
              <Col style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                <div className="card69">
                  ...
                  <span>About Me</span>
                  <p className="info">Assalamualaikum. I am Ruslan Sunbeeb, a health enthusiast dedicated to improving people&apos;s well-being. Passionate about health issues, I use my knowledge and skills to promote a healthier, happier world. Striving for the betterment of humanity, I work through informed, compassionate efforts to make a positive impact on lives.</p>
                  <div className="share">
                    <a href=""><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-github" viewBox="0 0 16 16">
                    <path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.012 8.012 0 0 0 16 8c0-4.42-3.58-8-8-8z"></path>
                    </svg></a>
          ...
          <Container>
            <Row>
              <Col style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start', textAlign: 'left', paddingLeft: '5%' }}>
                <h6 style={{paddingBottom:'3%', fontFamily:'Roboto', color: '#AFAA8A'}}>Contact us</h6>
                <h3 style={{paddingBottom:'3%', maxWidth:'55%', fontFamily:'Quando', color:'white'}}>Bridging the gap in healthcare access</h3>
                <div style={{ maxWidth: '70%', fontFamily: 'Roboto', fontSize: '15px', color: '#BFC6BD', paddingBottom:'3%' }}>
                  At the heart of MediShare’s mission is a deep commitment to empowering underserved communities and ensuring equitable access to essential medical resources
                </div>
                <div className="button-container">
